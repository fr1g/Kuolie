<template>
    <div class="modal-ararararrara">
        ...
        <div class="grid grid-cols-12 gap-2 mt-3 ">
            ...
            <Press id="DELCONFIRMBUTTON"
                :overclass="`text-lg font-semibold block modal-xxx text-center ${this.clicked ? 'bg-red-500' : 'bg-red-300'}`"
                :disable="clicked == null ? 'true' : 'false'" class="col-span-4" is-for-modal-close="false"
                @click.native="handler" init-opacity="60">
